...
import postImage from "./cosmetic-surgery-loan3.jpg";
import BlogPost from "@/components/BlogPost";
import { users } from "@/utils/constant";

export const article = {
  title: "Cosmetic Surgery Loan – How It Can Benefit You In Different Ways",
  description:
  ...
  publishedOn: "2020-12-06T13:28:20-0400",
  image: postImage,
