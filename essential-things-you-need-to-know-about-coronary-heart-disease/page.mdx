...
import postImage from "./coronary-heart-disease.jpg";
import BlogPost from "@/components/BlogPost";
import { users } from "@/utils/constant";

export const article = {
  title: "essential things you need to know about coronary heart disease",
  description:
  ...
  publishedOn: "2020-12-17T13:28:20-0400",
  image: postImage,
