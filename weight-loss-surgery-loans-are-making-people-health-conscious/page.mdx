...
export const article = {
  title: "weight loss surgery loans are making people health conscious",
  description:
    "Weight loss surgery Weight Loss Surgery Loans Are Making People Health-Conscious - TLC - 1 Excessive body weight has severe health implications. It limits one’s ability to live life",
  publishedOn: "2021-06-13T13:28:20-0400",
  image: postImage,
