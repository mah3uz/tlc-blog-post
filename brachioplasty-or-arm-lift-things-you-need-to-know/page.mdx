...
import postImage from "./Brachioplasty2.jpg";
import BlogPost from "@/components/BlogPost";
import { users } from "@/utils/constant";

export const article = {
  title: "brachioplasty or arm lift things you need to know",
  description:
...
Loose and sagging skin under the arms is one of the most common complaints of massive
weight loss patients. However, it can also be a hereditary issue where genetics don’t
play in your favour as you age. The condition can also be referred to as ‘bingo wings’
or ‘bat wings’. Either way, a brachioplasty or arm lift is an increasingly more popular
operation that patients undergo to rectify the issue. We asked Dr Gavin Sandercoe,
Plastic and Cosmetic Surgeon based in Sydney, to tell us everything we need to know
about a brachioplasty or an arm lift.
